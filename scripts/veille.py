...
# -*- coding: utf-8 -*-
"""
Veille hebdomadaire Actualites — ACTU EYES.
...
Qui parle. Les articles sont signés « l'équipe ACTU EYES ». Tu écris au « nous ».
...
que si la nouveauté relève d'au moins une de ces catégories :
  ...
  - changement réglementaire ou de remboursement touchant l'optique ;
...
FORMAT DE RÉPONSE — du JSON pur, rien avant, rien après, aucune balise markdown :
{
  ...
  "body_html": "<h2>...</h2><p>...</p>..."
    ...
    write_summary(
        ...
        "En ligne dans quelques minutes ici : https://actueyes-montreuil.fr/actualites/%s.html\n\n"
        "- Rubrique : %s\n- Source : %s\n- Pourquoi ce sujet : %s\n- Longueur : %d mots\n\n"
